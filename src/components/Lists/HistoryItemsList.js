...
export default (props) => {
    ...
    function sendTempHistory() {
        saveHistory();
        props.navigation.navigate("History", { history: props.history });
    }

    return (
        <View>
            <TouchableOpacity onPress={() => sendTempHistory()}
                ...
                <View style={{ width: "70%" }}>
                    ...
                    <Text style={listStyles.itemSubtitle2}>{props.history.paymentMethod}</Text>
                </View>
            </TouchableOpacity>
